      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildButton(context, Icons.phone_android, 'Continue with phone number'),
            const SizedBox(height: 10),
            _buildButton(context, Icons.animation_rounded, 'Continue with Google'),
            const SizedBox(height: 10),
